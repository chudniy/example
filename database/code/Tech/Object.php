<?php
/**
 * Класс с основными функциями обработки и хранения данных.
 *
 * @package  Tech
...
class Tech_Object implements ArrayAccess
{
    /**
     * Object attributes
     *
    ...
    public function getData($key='', $index=null)
    {
        ...
        if (strpos($key,'/')) 
        {
            ...
            foreach ($keyArr as $i=>$k) 
            {
                ...
                elseif ($data instanceof Tech_Object) 
                {
                    $data = $data->getData($k);
                } 
                else 
        ...
        if (isset($this->_data[$key])) 
        {
            ...
            elseif ($value instanceof Tech_Object) 
            {
